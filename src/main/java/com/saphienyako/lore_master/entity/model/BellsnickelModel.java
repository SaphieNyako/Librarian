package com.saphienyako.lore_master.entity.model;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import com.saphienyako.lore_master.entity.BellsnickelEntity;
import com.saphienyako.lore_master.entity.animations.BellsnickelAnimations;
...
public class BellsnickelModel<T extends Entity> extends HierarchicalModel<T> {
    ...
    public BellsnickelModel(ModelPart root) {
        ...
        this.book6 = this.head.getChild("book6");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition book6 = head.addOrReplaceChild("book6", CubeListBuilder.create().texOffs(54, 29).addBox(-4.0F, -3.0F, -3.0F, 8.0F, 3.0F, 8.0F, new CubeDeformation(0.0F))
                .texOffs(64, 40).addBox(-2.0F, 0.0F, -3.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F))
                .texOffs(81, 40).mirror().addBox(-2.0F, 0.0F, 5.0F, 2.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, -5.5F, -2.5F));
